...
7. Vault receives the targetted currency exchanged by the aggregate exchange module.
...
18. Vault collects 20% of the yield, which is transferred to the `Treasury`.
